 ...
 * @constructor
 * @param {!number} trackID - Unique identifier used in sorting after shuffle
 * @param {!string} coverArt -  URL to cover art image
 * @param {!string} title
 * @param {!string} artist
 * @param {!string} source - URL to music file
 */
function Track(trackID, coverArt, title, artist, album, source) {
  /** @readonly*/
  this.ID = trackID;
  /** @readonly*/
...
export { ActionTypes, AudioOutput, CustomNativeEventTypes, MediaState, RepeatMode, Track };
